...
create_car(description: 'tech geek but also a family man', model: 'Model X', brand: 'Tesla', year: 2020, price: 175, user: user3, folder: 'app/assets/images/model x', range: 497)
create_car(description: 'you like living in the fast lane', model: 'Taycan', brand: 'Porsche', year: 2020, price: 250, user: user2, folder: 'app/assets/images/taycan', range: 400)
create_car(description: 'tech geeks first choice', model: 'Model 3', brand: 'Tesla', year: 2020, price: 150, user: user3, folder: 'app/assets/images/model 3', range: 354)
create_car(description: 'became the first electric car to top the monthly new-car-sales ranking in any country in 2013', model: 'Model S', brand: 'Tesla', year: 2020, price: 125, user: user2, folder: 'app/assets/images/model s', range: 520)
